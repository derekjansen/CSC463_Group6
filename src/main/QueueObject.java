...
public class QueueObject 
{
	...
	public QueueObject(String function, int functionId)
	{
	...
	public QueueObject(String function, int functionId, String rc1, int c1id)
	{
		this.function = function;
		this.functionId = functionId;
	...
	public QueueObject(String function, int functionId, String rc1, int c1id, String rc2, int c2id)
	{
		this.function = function;
		this.functionId = functionId;
		this.randomComponent1 = rc1;
